class BlanksController < ApplicationController
  ...
  dried_options ({
    fields:
      [:name, :brand, sides_attributes: [:id, :name, :attachment, :attachment_data, :down_the_collar, :artwork_width, :measurement_unit, :_destroy], properties_attributes: [:id, :prop_type, :method, :name, :element_id, :back_element_id, :hex, :_destroy],
